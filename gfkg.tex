...
\section{The Second Pair of Equations}
...
\chapter{DeRham Theory in Electromagnetism}
...
Let $f$ be a 0-form on $M$. The boundary of $M$ is $\partial M = {\{0\}}^-$ so, by Stokes' theorem,
\[
...
\]
where $d\vec{A}$ is as in solution~\ref{sol:classicstokestheorem}. Therefore, by Stokes' theorem,
\[
