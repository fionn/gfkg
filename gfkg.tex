...
\begin{align*}
    [v, w]f &= v(w(f)) - w(v(f)) \\
        ...
        &= \frac{1}{x^2 + y^2}
            \begin{pmatrix}
                x \partial_x (x\partial_y f) - x\partial_x(y \partial_x f) + y \partial_y(x\partial_y f) - y \partial_y(y \partial_x f) \\
                -\, x\partial_y(x\partial_x f) - x\partial_y(y\partial_y f) + y\partial_x(x \partial_x f) + y\partial_x (y \partial_y f)
            \end{pmatrix} \\
